...
import { deleteUser, editUser, login, registeringAdmin, registeringEmployee, registeringOwner } from "../controllers/userController";
...
router.delete("/", authentication, authorizeRole("OWNER", "SUPER ADMIN", "ADMIN"),deleteUser)
